...
class GL_equations_set:
    ...
    def __init__(self,params_dict:dict[str,float],t_max, t_mesh,x_max,x_mesh):
        '''
        ...
        self.grid=pde.CartesianGrid([[0,x_max]],[x_mesh],periodic=False)
    ...
    def solve(self,file='out_file.hdf5'):
        ...
        es = self.equations.solve(self.state, t_range=self.time_domain[0], dt=self.time_domain[1], tracker=storage.tracker(0.1))  # solve the PDE
        return es
